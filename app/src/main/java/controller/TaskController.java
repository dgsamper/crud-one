...
public class TaskController {
    ...
    public void save(Task task) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Error. Task not saved" + ex.getMessage(), ex);    
        } finally {
    ...
    public void update(Task task) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Error. Task not updated" + ex.getMessage(), ex);    
        } 
    ...
    public void removeById(int taskId) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Error. Task not deleted");
        } finally {
            ConnectionFactory.closeConnection(connection, statement);
        }
    ...
    public List<Task> getAll(int idProject) throws RuntimeException {
        ...
        // task list. returned when called
        ...
        try {
            ...
            throw new RuntimeException("Error. Task not inserted");
        } finally {
